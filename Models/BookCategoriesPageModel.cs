...

{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(laboratorul2Context context,
        Book book)
        {
            ...
            foreach (var cat in allCategories)
            {
                ...
                {
                    CategoryID = cat.ID,
                    Name = cat.CategoryName, // Folosește `Name` conform definiției
                    Assigned = bookCategories.Contains(cat.ID) // Verifică dacă categoria este asociată cu cartea
                });
            }
        }
        public void UpdateBookCategories(laboratorul2Context context,
